  ...
  return replaceTarget
      ...
      return `
        <div class="item">
          <div class="item__figure">
            <img src="https://images-na.ssl-images-amazon.com/images/I/${img}._SL10_.jpg" data-src="https://images-fe.ssl-images-amazon.com/images/I/${img}.jpg" content="https://images-fe.ssl-images-amazon.com/images/I/${img}.jpg" width="240" height="240" alt="${text}" class="item__img">
          </div>
    ...
    .replace(replaceAmazon, (match, id, text) => {
      ...
      return `
        <div class="item">
          <div class="item__figure">
            <img src="https://images-fe.ssl-images-amazon.com/images/P/${id}._SL10_.jpg" data-src="https://images-fe.ssl-images-amazon.com/images/P/${id}.jpg" content="https://images-fe.ssl-images-amazon.com/images/P/${id}.jpg" width="240" height="240" alt="${text}" class="item__img">
          </div>
          <div class="item__container">
            <div class="item__name">
              <span class="item__title">${title}</span>
